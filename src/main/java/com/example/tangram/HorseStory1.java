...
public class HorseStory1 implements Initializable {
    ...
    private static final String textToShow1 = "After disembarking from the ship, Tan still had a long way to go. Vast plain fields lay in front of him. ";

    private static final String textToShow2 = "To cover those fields, Tan required his trusty horse. Now, it is your job to create Tan's horse for him.";
    ...
    public void onSkiphs1ButtonPressed() throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("horse.fxml"));
