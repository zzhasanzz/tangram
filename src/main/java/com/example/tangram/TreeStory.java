...
public class TreeStory implements Initializable {
    ...
    private static final String textToShow1 = "As Tan let out a sigh of relief after travelling the entire field, he saw a very dark and dense forest ahead of him.";

    private static final String textToShow2 = "Now, it is your job to make Tan's hardship easier by making a simple tree!";
