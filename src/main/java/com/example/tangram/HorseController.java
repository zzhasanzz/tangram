...
public class HorseController {
    ...
    private void initialize() {
        ...
        small2.setFill(new ImagePattern(woodTexture));
        mid.setFill(new ImagePattern(woodTexture));
        parallelogram.setFill(new ImagePattern(woodTexture));
        rectangle.setFill(new ImagePattern(woodTexture));
        large1.setFill(new ImagePattern(woodTexture));
        small1.setFill(new ImagePattern(woodTexture));
