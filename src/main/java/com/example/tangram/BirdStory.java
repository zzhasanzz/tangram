...
public class BirdStory implements Initializable {
    ...
    private static final String textToShow1 = "As Tan was resting, something caught his attention. Out of the blue came a very big bird. The big bird swooped down on Tan, trying to snatch his bag.";

    private static final String textToShow2 = " Now, your task is to complete the shape of the big bird.!";
    ...
    public void onSkiphs1ButtonPressed() throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("bird.fxml"));
