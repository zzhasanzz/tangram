...
public class TanStory implements Initializable {
    ...
    private static final String textToShow1 = "Tan grew heavily tired after his journey. He found a tree with the thickest of branches and the coziest of shades. ";

    private static final String textToShow2 = "Now, your task is to complete the shape of a tired and resting Tan!";
    ...
    public void onSkiphs1ButtonPressed() throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("tan.fxml"));
